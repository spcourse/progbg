...
# Plotting in CS50 IDE

If you work in a non graphic environment (like the CS50 IDE), the examples above will give an error:

    _tkinter.TclError: couldn't connect to display ":0"

This is because the environment doesn't have a way to directly display the images.

In order to solve this, you have to replace this line:
...
And instead of showing the image directly:
...
This saves the plot to "plot.png" in the working directory. You can now open it by double clicking on it in the file browser.
